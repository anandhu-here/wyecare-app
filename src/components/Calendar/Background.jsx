        ...
        <View style={{paddingVertical:"5%", alignItems:"center"}}  >
            ...
            </View>
            {
                s?(
                    ...
                    <Text style={{textAlign:"center", fontSize:16, fontWeight:'600', color:"grey"}} >{userInfo.user.carer?"You haven't":profile.first_name + "hasn't"} covered any shifts yet </Text>
                )
            }
                    ...
                    if(b.employee_id !== profile.agent.id){
                        return(
                            <View style={{width:"100%", justifyContent:"center", alignItems:"center"}} >
                                ...
                                {
                                    b.start_date?(
                                        <Text style={{fontSize:16, fontWeight:"600", color:"grey"}} >{b.start_date} - {b.end_date}</Text>
                                    ):(
                                        <Text style={{textAlign:"center", fontSize:16, fontWeight:'600', color:"grey"}} >{userInfo.user.carer?"You haven't":profile.first_name + "hasn't"} covered any shift </Text>
                                    )
                                }
                            </View>
                        )
